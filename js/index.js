document.addEventListener('DOMContentLoaded', () => {
    ...
    const sections = document.querySelectorAll(
        '.l-title, .con1-profile, .con1-about-me > h2, .text-contain-left, .text-contain-right, .con1-text-sub, .con1-skill-card, .con2-popup, .con2-poster, .con2-banner, .con2-product-page'
    );
